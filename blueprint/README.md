...
> This document is intended for human reading only. AI developers should ignore this document and start reading from repository root `AGENTS.md`.
...
The following markdown documents provide deeper reference material for this template:

- `modular_mannual.md` – modular development model, module instances, workdocs, and cross-module structure.
- `agents_strategy_guide.md` – how `AGENTS.md` files at different levels guide AI behavior.
